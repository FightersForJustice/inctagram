  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <input
        ...
        id="password"
      />
      <label htmlFor="password" onClick={() => setIsPasswordShown((prev) => ({ ...prev, password: !prev.password }))}>
        o
      </label>
      <br></br>
      ...
      <label
        ...
        onClick={() => setIsPasswordShown((prev) => ({ ...prev, confirmPassword: !prev.confirmPassword }))}
      >
        o
      </label>
      <br></br>
