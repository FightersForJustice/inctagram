          ...
          <img className={style.img} src="/img/Loading.svg" alt="github.com" />
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div>
                    ...
                    <input onClick={() => setArr([])}  className={errors.userName || errorMessageName ? style.error : ''} {...register("userName",{
                              required: {
                                value: true,
                ...
                <div>
                    <label>Email</label>
                    <input onClick={() => setArr([])} className={errors.email || errorMessageEmail ? style.error : ''} {...register("email",{
                              required: {
                                value: true,
                                message: "* Required field to fill in",
                              },                        
                ...
                <div>
                    ...
                    <input onClick={() => {setArr([]);setPas("")}} className={errors.password || errorMessagePassword ? style.error : ''} type="password" {...register("password",{
                              required: {
                                value: true,
                                message: "* Required field to fill in",
                              },
                ...
                <div>
                    ...
                    <input onClick={() => {setArr([]);setPas("")}} className={errorMessagePassword ? style.error : ''} type="password" {...register("password2",{
                                required: {
                                value: true,
                                message: "* Required field to fill in",
                                },
