...
describe('date picker renders correctly', () => {
  ...
  it('should render error correctly', () => {
    const { asFragment } = render(<MainDatePicker value="99/99/9999" />)
    expect(asFragment()).toMatchSnapshot()
  })

  it('should render disabled correctly', () => {
    const { asFragment } = render(<MainDatePicker disabled />)
    expect(asFragment()).toMatchSnapshot()
  })

  it('should render default with open picker correctly', () => {
    const { asFragment } = render(<MainDatePicker />)
  ...
  it('should render error with open picker correctly', () => {
    const { asFragment } = render(<MainDatePicker value="99/99/9999" />)
